...
//    }
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let listIndex = list[indexPath.row]
        cell.indexLable.text = listIndex.listName
        cell.indexImage.image = UIImage(systemName: listIndex.listImage)
